  ...
  return (
    <div className="mx-auto max-w-lg space-y-6 rounded-[2rem] border border-slate-200 bg-white/90 p-8 shadow-soft dark:border-slate-800 dark:bg-slate-950/95">
      <div className="space-y-3">
        <h1 className="text-3xl font-semibold">Login to ShopXpress</h1>
        <p className="text-slate-600 dark:text-slate-300">Access your cart, orders, and saved preferences with a secure login.</p>
      </div>
